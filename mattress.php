...
<style>
<?php include 'css/mattressstyle.css'; ?>
...
<body>
  <div class="nav_bar">
		...
		<div class="top">
			<img src="image/mattress1.jpg">
			<h3>Simple Material,</h3><br><h4>Better Price</h4>
			<p>
				Take the Sleep Quiz now to find out which<br> of our four mattresses is best for you.
				<br><br>
				<a href="contact.php">Contact Us for more details</a>
			</p>
		</div>

		<div class="list">
            <div class="lom">
                <h1>List of Mattresses</h1>
            </div>
            <div class="list1">
                <div class="pic1">
                    <a href="#foam_m"><img src="image/mattress2.png"> </a>
                    <p>Foam Mattress</p>
                </div>
                <div class="pic2">
                    <a href="#spring_m"><img src="image/mattress3.jpg"></a>
                    <p>Spring Mattress</p>
                </div>
                <div class="pic3">
                    <a href="#hybrid_m"><img src="image/mattress4.jpg"></a>
                    <p>Hybrid Mattress</p>
                </div>
            </div>
        </div>

        <div class="container mt-5" id="foam_m">
    <h3 class="text-center"> <?php echo $foam; ?></h3>

    <div class="row">
      <?php
      $single_ = mysqli_query($conn, "SELECT * FROM `mattress_tbl` WHERE Type =  '$foam'");
      ?>
      <?php
      ...
      ?>
        <div class="col-md-4">
          <div class="card hover">
            <div class="card-img">
              <img src="<?php echo $row['Image']; ?>" class="card-img-top" alt="..." width="100" height="220px" style="object-fit: cover;">
              <div class="overlay">
                <div class="overlay-content">
                  <?php  if ($row['Stock']> 0){?><a class="btn btn-warning" href="order.php?id=<?php echo $row['id'].'&mattresstype='.  $row['Type'];?>">Order Now</a> <?php }
                   elseif($row['Stock']<= 0)
    ...
    <div class="container" id="spring_m">
      <h3 class="text-center"> <?php echo $spring; ?></h3>
      <div class="row">
        <?php
        $single_ = mysqli_query($conn, "SELECT * FROM `mattress_tbl` WHERE Type = '$spring'");
        ?>
        <?php
        while ($row = mysqli_fetch_assoc($single_)) {
        ?>
  ...
  <div class="container" id="hybrid_m">
    <h3 class="text-center"> <?php echo $hybrid; ?></h3>
    <div class="row">
      <?php
      $single_ = mysqli_query($conn, "SELECT * FROM `mattress_tbl` WHERE Type = '$hybrid'");
      ?>
      <?php
      while ($row = mysqli_fetch_assoc($single_)) {
      ?>
