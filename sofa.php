...
$sectional = "Sectional/Modular Sofa";
?>
<style>
<?php include 'css/sofastyle.css'; ?>
...
<body>
    ...
    <div class="nav_bar">
		...
		<div class="top">
			<img src="image/sofa2.jpg">
			<h6>
				The New Design Collection
			</h6>
			<p>
				Most Comfortable and Aesthetic Designs<br>
				For more details <b><a href="contact.php">Contact US</a></b>
			</p>
		</div>
		...
		<div class="top2">
            ...
            <div class="top3">
                <div class="imag1">
                    <a href="#arm"><img src="image/img1.jpg"></a>
                    <p>Armchair</p>
                </div>
                <div class="imag2">
                    <a href="#lov"><img src="image/img2.jpg"></a>
                    <p>Loveseat/Sofa</p>
                </div>
                <div class="imag3">
                    <a href="#hy"><img src="image/img3.jpg"></a>
                    <p>Sectional Modular Sofa</p>
                </div>
            </div>
        </div> 


        <div class="container mt-5" id="arm">
    <h3 class="text-center"> <?php echo $armchair; ?></h3>

    <div class="row">
      <?php
      $single_ = mysqli_query($conn, "SELECT * FROM `sofa_tbl` WHERE Type = '$armchair'");
      ?>
      <?php
            ...
            <div class="card-img">
              ...
              <div class="overlay">
                <div class="overlay-content">
                  <?php  if ($row['Stock']> 0){?><a class="btn btn-warning" href="order.php?id=<?php echo $row['id'].'&sofatype='.  $row['Type'];?>">Order Now</a>
                  <?php 
                  }
                   elseif($row['Stock']<= 0)
    ...
    <div class="container" id="lov">
      <h3 class="text-center"> <?php echo $loveseat; ?></h3>
      <div class="row">
        <?php
        $single_ = mysqli_query($conn, "SELECT * FROM `sofa_tbl` WHERE Type = '$loveseat'");
        ?>
        <?php
        while ($row = mysqli_fetch_assoc($single_)) {
        ?>
  ...
  <div class="container" id="hy">
    <h3 class="text-center"> <?php echo $sectional; ?></h3>
    <div class="row">
      <?php
      $single_ = mysqli_query($conn, "SELECT * FROM `sofa_tbl` WHERE Type = '$sectional'");
      ?>
      <?php
      while ($row = mysqli_fetch_assoc($single_)) {
      ?>
